...
if [ "$1" == "stop" ]; then
    ...
    pkill -f "python /home/kyeou/CSUN-Catalog-And-Schedules/bot.py --config /home/kyeou/CSUN-Catalog-And-Schedules/config.json"
...
python /home/kyeou/CSUN-Catalog-And-Schedules/bot.py --config /home/kyeou/CSUN-Catalog-And-Schedules/config.json &
